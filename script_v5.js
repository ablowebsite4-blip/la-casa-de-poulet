...
const DEFAULT_MENU = {
    ...
    pizza: {
        ...
        items: [
            ...
            { id: "piz-thon", name: "Pizza Thon", priceP: 25, priceM: 35, isPizza: true },
            { id: "piz-mixt", name: "Pizza Mixt", priceP: 30, priceM: 40, isPizza: true },
            { id: "piz-4saison", name: "Pizza 4 Saison", priceP: 32, priceM: 40, isPizza: true },
            { id: "piz-mer", name: "Pizza Fruit de Mer", priceP: 32, priceM: 40, isPizza: true },
            { id: "piz-pepperoni", name: "Pizza Pepperoni", priceP: 32, priceM: 40, isPizza: true }
        ]
    },
    tacos: {
        label: "LES TACOS",
        ...
        items: [
            ...
            { id: "tac-charcut", name: "Tacos Charcuterie", price: 25 },
            ...
            { id: "tacg-charcut", name: "Tacos Charcuterie", price: 30, badge: "Gratiné", badgeColor: "red" },
    ...
    pasticcio: {
        ...
        emoji: "🫕",
        items: [
            { id: "pas-poulet", name: "Pasticcio Poulet", price: 25 },
            { id: "pas-dinde", name: "Pasticcio Dinde", price: 25 },
            { id: "pas-viandh", name: "Pasticcio Viande H.", price: 25 },
            { id: "pas-mixt", name: "Pasticcio Mixt", price: 30 },
            { id: "pas-charcut", name: "Pasticcio Charcuterie", price: 25 },
            { id: "pas-negutte", name: "Pasticcio Negutte", price: 25 },
            { id: "pas-cordon", name: "Pasticcio Cordon Bleu", price: 30 },
            { id: "pas-mer", name: "Pasticcio Fruit de Mer", price: 35 },
            { id: "pas-crispy", name: "Pasticcio Crispy", price: 28, badge: "⚡ Crispy", badgeColor: "orange" }
        ]
    },
    sandwich: {
        label: "LES SANDWICH",
        ...
        items: [
            ...
            { id: "san-negutte", name: "Sandwich Negutte", price: 15 },
            { id: "san-saucisse", name: "Sandwich Saucisse", price: 15 },
            { id: "san-crispy", name: "Sandwich Crispy", price: 17, badge: "⚡ Crispy", badgeColor: "orange" }
        ]
    },
    baguetto: {
        label: "BAGUETTO",
        ...
        emoji: "🥖",
        items: [
            { id: "bag-poulet", name: "Baguetto Poulet", price: 25 },
            { id: "bag-dinde", name: "Baguetto Dinde", price: 25 },
            { id: "bag-viandh", name: "Baguetto Viande H.", price: 25 },
            { id: "bag-mixt", name: "Baguetto Mixt", price: 30 },
            { id: "bag-crispy", name: "Baguetto Crispy", price: 28, badge: "⚡ Crispy", badgeColor: "orange" }
        ]
    },
    qussadilla: {
        label: "QUSSADILLA",
    ...
    plats: {
        ...
        emoji: "🍽",
        items: [
            { id: "pla-poulet", name: "Plat Poulet", priceSimple: 25, priceSalade: 35, isPlat: true },
    ...
    crispy: {
        ...
        items: [
            ...
            { id: "cri-bag", name: "Baguetto Crispy", price: 28, badge: "⚡ Crispy", badgeColor: "orange" },
            { id: "cri-quas", name: "Quassadilla Crispy", price: 28, badge: "⚡ Crispy", badgeColor: "orange" }
        ]
    },
    salades: {
        label: "LES SALADES",
    ...
    boissons: {
        label: "JUS & BOISSONS",
        labelAr: "عصائر ومشروبات",
        emoji: "🥤",
        items: [
            { id: "boi-banane", name: "Jus Banane", price: 12, emoji: "🍌" },
            { id: "boi-pomme", name: "Jus Pomme", price: 12, emoji: "🍎" },
            { id: "boi-avocat", name: "Jus Avocat", price: 15, emoji: "🥑" },
            { id: "boi-orange", name: "Jus Orange", price: 12, emoji: "🍊" },
            { id: "boi-canette", name: "Boisson Canette", price: 6, emoji: "🥫" },
            { id: "boi-1l", name: "Boisson 1L", price: 12, emoji: "🍶" }
        ]
    }
};
